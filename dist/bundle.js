...
socket.onmessage = function (event) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__game_js__["a" /* default */].showMessage(incomingMessage);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    createGameField() {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            for (let a = 0; a < 10; a++) {
                ...
                id++;
                tr.appendChild(td);
                __WEBPACK_IMPORTED_MODULE_0_jquery___default.a(td).mouseenter(function () {
                    console.log(this);
                    ...
                    if (game.selectedBoat.deck == 2) {
                        if (parseInt((cellId / 10), 10) !== (cellId / 10)) {
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#battleground table tr #' + nextCellId).css({
    ...
    createBoat(id, deck, color) {
        ...
        let game = this;
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a(div).click(function () {
            console.log(this);
    ...
    showMessage(message) {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#info').text('');
        __WEBPACK_IMPORTED_MODULE_0_jquery___default.a('#info').text(message);
    }
});
